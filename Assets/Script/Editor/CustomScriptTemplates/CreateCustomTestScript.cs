...
public class CreateCustomTestScript
{
    private const string MenuItemPath = "Assets/Create/Custom C# TestScript";
    private const int MenuItemPriority = 80;
    private const string DefaultScriptName = "NewScript.cs";
    private const string TemplatePath = "Assets/Script/Editor/CustomScriptTemplates/CustomTestScriptTemplate.txt";
